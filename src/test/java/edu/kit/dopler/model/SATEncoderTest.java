...
public class SATEncoderTest extends TestCase {
    ...
    public void testVariantsWaterfilter() throws NotSupportedVariabilityTypeException, IOException {
        ...
        Dopler dopler = readDOPLERModelFromFile(
                Path.of(System.getProperty("user.dir") + "/modelEval/product_waterfilter.csv"));
    ...
    public void testVariantsHICSSDM() throws NotSupportedVariabilityTypeException, IOException {
        ...
        assertEquals(4185, getAmountOfConfigs(dopler,
                "(assert (= END_DECISION_0_Particular_Packages true)) (assert (= END_DECISION_3_Document_Management true)) (assert (= END_DECISION_3_Customer_Management true)) (assert (= END_DECISION_3_Claims_Management true))"));
    ...
    public void testVariantsDoplerTools() throws NotSupportedVariabilityTypeException, IOException {
        ...
        Dopler dopler = readDOPLERModelFromFile(
                Path.of(System.getProperty("user.dir") + "/modelEval/dm_DOPLERTools2.csv"));
    ...
    public void testVariantsrockerswitch() throws NotSupportedVariabilityTypeException, IOException {
        ...
        Dopler dopler = readDOPLERModelFromFile(
                Path.of(System.getProperty("user.dir") + "/modelEval/product_rockerswitch.csv"));
    ...
    public void testVariantsShiftfork() throws NotSupportedVariabilityTypeException, IOException {
        ...
        Dopler dopler = readDOPLERModelFromFile(
                Path.of(System.getProperty("user.dir") + "/modelEval/product_shiftfork.csv"));
    ...
    public void testVariantsTruck() throws NotSupportedVariabilityTypeException, IOException {
        ...
        Dopler dopler = readDOPLERModelFromFile(
                Path.of(System.getProperty("user.dir") + "/modelEval/product_truck.csv"));
    ...
    public void testVariantsChesspiece() throws NotSupportedVariabilityTypeException, IOException {
        ...
        Dopler dopler = readDOPLERModelFromFile(
                Path.of(System.getProperty("user.dir") + "/modelEval/product_chesspiece.csv"));
    ...
    /**
     * Asserts that a decision is not Taken but another isTaken with the visibility
     * condition (if the first isTaken) -> so it should be unsat
     * 
     * @throws Exception
     */
    public void testDissModelwithUnsatAssert() throws Exception {
        ...
        Dopler dopler = readDOPLERModelFromFile(
                Path.of(System.getProperty("user.dir") + "/modelCSVs/dm_DissModel.csv"));
        Stream.Builder<String> builder = dopler.toSMTStream();
    ...
    public void testDoplerModelVaMoS() throws Exception {
        ...
        BooleanDecision decision1 = new BooleanDecision("test", "Support GSM 1900 protocol?", "",
        ...
        EnumerationDecision decision2 = new EnumerationDecision("test", "Which audio formats shall be supported?", "",
                new BooleanLiteralExpression(true), new HashSet<>(), enumerationDecision2, 1, 2);
        dopler.addDecision(decision2);

        BooleanDecision decision3 = new BooleanDecision("test", "Support for taking photos?", "",
                new BooleanLiteralExpression(true), new HashSet<>());
        ...
        IExpression expression = new Equals(new DecisionValueCallExpression(decision3),
                new BooleanLiteralExpression(true));
        EnumerationDecision decision4 = new EnumerationDecision("test", "Required camera resolution?", "", expression,
                new HashSet<>(), enumerationDecision4, 1, 1);
        dopler.addDecision(decision4);

        BooleanDecision decision5 = new BooleanDecision("test", "Support for recording MP3 audio?", "",
                new BooleanLiteralExpression(true), new HashSet<>());
        IExpression expression2 = new Equals(new DecisionValueCallExpression(decision5),
                new BooleanLiteralExpression(true));
    ...
    public void testDoplerModelEShop() throws Exception {
        ...
        Dopler dopler = new Dopler(new HashSet<>(), new HashSet<>(), new HashSet<>(), "");
        BooleanDecision decision1 = new BooleanDecision("test", "Do you want to create an Onlineshop?", "",
                new BooleanLiteralExpression(true), new HashSet<>());
        dopler.addDecision(decision1);
        ...
        EnumerationDecision decision2 = new EnumerationDecision("test", "Which payment methods should be supported??",
                "", new BooleanLiteralExpression(true), new HashSet<>(), enumerationDecision2, 1, 1);
        dopler.addDecision(decision2);

        BooleanDecision decision3 = new BooleanDecision("test", "Should a search function be suppoted?", "",
                new BooleanLiteralExpression(true), new HashSet<>());
        IExpression expressionDecision3 = new Equals(new DecisionValueCallExpression(decision3),
        ...
        BooleanDecision decision4 = new BooleanDecision("test", "Split products into categories?", "",
                new BooleanLiteralExpression(true), new HashSet<>());

        BooleanDecision decision5 = new BooleanDecision("test", "Should products be sortable?", "",
                new BooleanLiteralExpression(true), new HashSet<>());

        dopler.addDecision(decision4);
        dopler.addDecision(decision5);

        EnumerationDecision decision6 = new EnumerationDecision("test",
                "Which user management enhancements should be supported?", "", new BooleanLiteralExpression(true),
                new HashSet<>(), enumerationDecision6, 1, 4);
        ...
        IExpression expression2Decision3 = new Equals(new DecisionValueCallExpression(decision3),
                new BooleanLiteralExpression(true));
        ...
        decision6.addRule(
                new Rule(
                        new NOT(new Equals(new DecisionValueCallExpression(decision6),
                                new EnumeratorLiteralExpression(new EnumerationLiteral("Security")))),
                        new HashSet<>() {
                            {
        ...
        decision6.addRule(
                new Rule(
                        new Equals(new DecisionValueCallExpression(decision6),
                                new EnumeratorLiteralExpression(new EnumerationLiteral("Security"))),
                        new HashSet<>() {
                            {
        ...
        decision6.addRule(
                new Rule(
                        new NOT(new Equals(new DecisionValueCallExpression(decision6),
                                new EnumeratorLiteralExpression(new EnumerationLiteral("Payments")))),
                        new HashSet<>() {
                            {
    ...
    public void testDoplerModelPizzas() throws Exception {
        ...
        EnumerationDecision decision2 = new EnumerationDecision("test", "Which Topping do you want on your pizza?", "",
                new BooleanLiteralExpression(true), new HashSet<>(), enumerationDecision2, 1, 3);
        dopler.addDecision(decision2);
        ...
        EnumerationDecision decision3 = new EnumerationDecision("test", "Which Size should the pizza have?", "",
                new BooleanLiteralExpression(true), new HashSet<>(), enumerationDecision3, 1, 1);
        dopler.addDecision(decision3);
        ...
        EnumerationDecision decision4 = new EnumerationDecision("test", "Which Dough do you prefer??", "",
                new BooleanLiteralExpression(true), new HashSet<>(), enumerationDecision4, 1, 1);
        dopler.addDecision(decision4);

        BooleanDecision decision1 = new BooleanDecision("test", "Should the pizza have a cheesy crust?", "",
                new BooleanLiteralExpression(true), new HashSet<>());
        dopler.addDecision(decision1);

        IExpression expressionDecision1 = new Equals(new DecisionValueCallExpression(decision1),
                new BooleanLiteralExpression(true));
    ...
    public void testDoplerModelPizzas2() throws Exception {
        ...
        IExpression expressionDecision3 = new Equals(new DecisionValueCallExpression(decision3),
                new EnumeratorLiteralExpression(new EnumerationLiteral("Big")));
        ...
        IExpression expressionDecision4 = new Equals(new DecisionValueCallExpression(decision4),
                new EnumeratorLiteralExpression(new EnumerationLiteral("Sicilian")));
